      ...
      <aside className="hidden lg:flex flex-col w-64 glass-card border-r border-slate-200/50 dark:border-slate-850/50 m-4 mr-0 rounded-3xl p-5 sticky top-4 h-[calc(100vh-2rem)] z-30">
        ...
        <div className="pt-4 border-t border-slate-200/50 dark:border-slate-850/50 space-y-3">
          <div className="flex items-center gap-3 px-2">
            {user?.photoURL ? (
              <img src={user.photoURL} alt={user.displayName || "Avatar"} className="w-9 h-9 rounded-full object-cover border border-slate-200 dark:border-slate-800" />
            ) : (
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="flex-1 py-2 px-3 rounded-xl border border-red-200/50 dark:border-red-950/20 flex items-center justify-center text-red-600 hover:text-white hover:bg-red-600 dark:hover:bg-red-650/30 transition-all text-xs gap-1"
            >
          ...
          <div className="lg:hidden absolute top-24 left-4 right-4 bg-white dark:bg-slate-950 rounded-2xl border border-slate-200 dark:border-slate-850 p-5 shadow-2xl z-50 space-y-4">
            ...
            <div className="pt-4 border-t border-slate-200 dark:border-slate-850 flex items-center justify-between gap-4">
              ...
              <button
                ...
                className="flex-1 py-2 px-3 rounded-xl border border-red-200 dark:border-red-950/20 flex items-center justify-center text-red-600 text-xs gap-1.5"
              >
                <LogOut className="w-4 h-4" />
                Logout
              </button>
